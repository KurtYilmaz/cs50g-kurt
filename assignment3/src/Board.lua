...
-- AS3.2 - both variation and color are level dependent
function Board:tileCreator(x_pos, y_pos)
	-- local color = math.random(18)
	-- local variety = math.random(6)
	local color = math.random(math.min(self.level + 6, 18))
	local variety = math.random(math.min(self.level / 4, 6))
...
function Board:initializeTiles()
	...
	for tileY = 1, 8 do
		...
		for tileX = 1, 8 do
			...
			-- local tile = Tile(tileX, tileY, math.random(18), math.random(6), shiny)
