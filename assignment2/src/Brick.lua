...
-- AS2.3 - added locked member to Brick class
function Brick:init(x, y, locked)
	...
	-- AS2.3 - increased particle buffer for locked bricks
...
function Brick:hit(hasKey)
	-- AS2.3 - can only "hit" brick if it's not locked, or you have a key
	if hasKey and self.locked then
		-- sound on hit
		-- AS2.3 - particle system overblown for locked bricks
