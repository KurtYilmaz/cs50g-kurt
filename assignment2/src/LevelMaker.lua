...
-- AS2.3 - wanted lock brick variable here, but funciton is statically called
function LevelMaker.createMap(level)
	...
	for y = 1, numRows do
		...
		for x = 1, numCols do
			...
			-- AS2.3 - logic for locking bricks
			local lockThisBrick = false
			-- Gives a 2% * level chance of a locked brick each,
			-- Maxes chance at 20% chance for each brick to be locked
			...
			b = Brick(
				...
				* 32                    -- multiply by 32, the brick width
				...
				-- AS2.3 - passes variable for containing locked brick
				lockThisBrick
			)
